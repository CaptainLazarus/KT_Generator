...
def walk_directory(directory_path, output_file_path):
...
walk_directory(test_directory, output_file)
...
#     find_string_from_array(extracted_elements, "def handle_user_response")
# )
